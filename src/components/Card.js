...
const Card = (props) => {
  console.log("this is the props in card", props);
    ...
    <div className="card">
      ...
      <div className="row">
        ...
        <div className="col-1-of-3">
          <p className="card__saletype">{props.saletype}</p>
          <p className="card__saletype">{props.home_type}</p>
          <p className="card__saletype">Sqft:{props.sqft}</p>
        </div>
      </div>
